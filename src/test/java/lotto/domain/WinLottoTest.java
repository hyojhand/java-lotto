...
class WinLottoTest {
    ...
    void winLotto_SameObject_Test() {
        WinLotto winLotto = new WinLotto(new Lotto(Set.of(1, 2, 3, 4, 5, 6)), 7);
        assertThat(winLotto).isEqualTo(new WinLotto(new Lotto(Set.of(1, 2, 3, 4, 5, 6)), 7));
    }
    ...
    void winLotto_DuplicateLottoNumber_Exception(String inputNumbers) {
        ...
        assertThatThrownBy(() -> new WinLotto(new Lotto(numbers), 7))
    ...
    void winLotto_DuplicateBonusNumber_ExceptionTest() {
        assertThatThrownBy(() -> new WinLotto(new Lotto(Set.of(1, 2, 3, 4, 5, 6)), 1))
                .isInstanceOf(IllegalArgumentException.class)
